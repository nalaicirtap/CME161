...
var TuringMesh = function() {
  ...
  this.create_turing_pattern = function() {
    //main geometry
    this.geometry = new THREE.TorusBufferGeometry(this.radius, this.thickness, this.mesh_detail, this.mesh_detail);
    ...
    this.geometry2 = new THREE.TorusBufferGeometry(this.radius,this.thickness, this.mesh_detail, this.mesh_detail);
    ...
    this.geometry3 = new THREE.TorusBufferGeometry(this.radius,this.thickness/1.01, this.mesh_detail, this.mesh_detail);
    this.geometry3.applyMatrix(new THREE.Matrix4().makeRotationX(-Math.PI / 2));
